...
const ProfessionalTools = () => {
  ...
  const tools = [
    { id: "invert", label: "Invert", asset: "https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/test-clones/2f5fd82e-0e64-4bc1-b8bd-486911a2d083-weavy-ai/assets/images/68224563d93b3ce65b54f07b_Invert@2x.avif" },
    ...
    { id: "inpaint", label: "Inpaint", asset: "https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/test-clones/2f5fd82e-0e64-4bc1-b8bd-486911a2d083-weavy-ai/assets/images/682245639e16941f61edcc06_Inpaint@2x.avif" },
    ...
    { id: "upscale", label: "Upscale", asset: "https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/test-clones/2f5fd82e-0e64-4bc1-b8bd-486911a2d083-weavy-ai/assets/images/682245638e6550c59d0bce8f_Upscale@2x.avif" },
    ...
    { id: "relight", label: "Relight", asset: "https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/test-clones/2f5fd82e-0e64-4bc1-b8bd-486911a2d083-weavy-ai/assets/images/68224563b4846eaa2d70f69e_Relight@2x.avif" },
  ];

  const defaultAsset = "https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/test-clones/2f5fd82e-0e64-4bc1-b8bd-486911a2d083-weavy-ai/assets/images/68223c9e9705b88c35e76dec_Default_402x-20.avif";

  // Finding the current active image asset
  const activeImage = tools.find(t => t.id === activeTool)?.asset || defaultAsset;
...
const ToolChip = ({ label, isActive, onHover, onLeave, className }: ToolChipProps) => {
  return (
    <div
      ...
      ${isActive ? "bg-black text-white border-black" : "hover:border-[rgba(0,0,0,0.2)]"}
      ${className}`}
