...
const modelsData = [
  ...
  { name: "Recraft V3", type: "image", src: "https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/test-clones/2f5fd82e-0e64-4bc1-b8bd-486911a2d083-weavy-ai/assets/images/6825887eda73c12eaa4c3ed8_Recraft_20V3-15.avif" },
...
export default function ModelShowcase() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (newIndex !== activeIndex && newIndex >= 0 && newIndex < modelsData.length) {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="relative h-[250px] lg:h-[400px] flex items-center overflow-hidden">
              <div 
                ...
                style={{ 
                  transform: `translateY(calc(50% - ${activeIndex * 64}px - 32px))` 
                }}
              >
                {modelsData.map((model, idx) => (
                  <div
