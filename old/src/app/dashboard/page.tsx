      ...
      <div className="grid min-h-screen w-full grid-cols-1 md:grid-cols-[280px_minmax(0,1fr)]">
        ...
        <aside className="border-b border-border px-4 py-5 md:border-b-0 md:border-r">
          ...
          >
            <div className="flex flex-1 flex-col gap-4">
              ...
              <Button className="h-11 w-full justify-start rounded-md bg-[#faffc7] px-4 text-[14px] font-medium text-black hover:bg-[#f4f8cd]">
                <PlusIcon />
                Create New File
              </Button>
        ...
        <div className="min-w-0 px-4 py-7 sm:px-8">
          <header className="flex flex-wrap items-center justify-between gap-4">
            ...
            <Button className="h-10 rounded-md bg-[#faffc7] px-4 text-[14px] font-medium text-black hover:bg-[#f4f8cd]">
              <PlusIcon />
              Create New File
            </Button>
          </header>
              ...
              {filesView === 'grid' ? (
                ...
                <div className="mt-6">
                  ...
                  <div className="mt-8 flex items-center justify-end gap-2 text-[14px] text-muted-foreground">
                    <span>
                      1–{fileItems.length} of {fileItems.length}
                    </span>
                    <Button
                      variant="ghost"
                      size="icon"
