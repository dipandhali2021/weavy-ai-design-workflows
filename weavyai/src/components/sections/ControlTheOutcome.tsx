    ...
    <section className="relative overflow-hidden bg-background">
      ...
      <div className="container mx-auto px-[5%] pt-20 pb-10 text-center relative z-10">
        ...
        <div className="relative h-[480px] w-full max-w-[1000px] mx-auto flex items-center justify-center">
          ...
          <div className="absolute left-0 top-1/2 -translate-y-1/2 flex flex-col gap-8 items-end pr-12">
            <div className="bg-white px-4 py-2 rounded-full border border-black/10 text-[0.875rem] font-medium shadow-sm translate-x-12 -translate-y-12">
              Crop
            </div>
            <div className="bg-white px-4 py-2 rounded-full border border-black/10 text-[0.875rem] font-medium shadow-sm -translate-x-8">
              Inpaint
            </div>
            <div className="bg-white px-4 py-2 rounded-full border border-black/10 text-[0.875rem] font-medium shadow-sm translate-x-4 translate-y-8">
              Outpaint
            </div>
            <div className="bg-white px-4 py-2 rounded-full border border-black/10 text-[0.875rem] font-medium shadow-sm -translate-x-4 translate-y-16">
              Upscale
            </div>
          </div>
          ...
          <div className="absolute right-0 top-1/2 -translate-y-1/2 flex flex-col gap-8 items-start pl-12">
            ...
            <div className="bg-white px-4 py-2 rounded-full border border-black/10 text-[0.875rem] font-medium shadow-sm translate-x-8 -translate-y-4">
              Channels
            </div>
            <div className="bg-white px-4 py-2 rounded-full border border-black/10 text-[0.875rem] font-medium shadow-sm -translate-x-4 translate-y-8">
              Relight
      ...
      <div className="container mx-auto px-[5%] pb-40">
        <div className="w-full max-w-[1100px] mx-auto bg-[#1A1A1A] rounded-[24px] overflow-hidden flex shadow-[0_40px_100px_rgba(0,0,0,0.25)] border border-white/5">
          {/* Left Sidebar - Layers */}
          <div className="w-60 flex flex-col border-r border-white/10 shrink-0">
            ...
            <div className="relative w-full aspect-[16/10] bg-[#222] rounded-lg overflow-hidden border border-white/10">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center z-20">
                <div className="text-center">
                  <div className="text-white/60 text-[10px] mb-2 font-medium bg-black/40 px-2 py-0.5 rounded backdrop-blur-sm">
                    Directed by
                  </div>
                  <div className="relative border border-black p-4 bg-white/5 backdrop-blur-md">
                    <span className="font-mono text-2xl text-black tracking-tight font-medium">
                      Michael Abernathy
                    </span>
