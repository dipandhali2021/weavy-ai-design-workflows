...
const workflows: WorkflowCard[] = [
  ...
  },
  {
    ...
    image:
      'https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/test-clones/2f5fd82e-0e64-4bc1-b8bd-486911a2d083-weavy-ai/assets/images/6835ce8a653081a97d92eebd_VIDEO_hero_Desktop-11.avif',
  },
];
              ...
              >
                ...
                <div className="relative aspect-[1.6/1] rounded-[12px] overflow-hidden bg-[#2A2A2A] border border-white/10">
                  <img
                    src={workflow.image}
                    alt={workflow.title}
                    className="absolute inset-0 h-full w-full object-cover opacity-90 transition-transform duration-500 group-hover/card:scale-105"
                    loading="lazy"
                    decoding="async"
                  />
                  {/* "Try" Button Layer */}
